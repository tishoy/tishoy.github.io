    ...
    */
    function showTips(e) {
        ...
        if (this._tips == null) {
            ...
            //tips定位
            if (point.x + this._tips.width > GameConfig.curWidth()) {
                point.x = GameConfig.curWidth() - this._tips.width;
            }
            else if (point.x < 0) {
                point.x = 0;
            }
            if (point.y + this._tips.height > GameConfig.curHeight()) {
                point.y = GameConfig.curHeight() - this._tips.height;
            }
            else if (point.y < 0) {
                point.y = 0;
            }
