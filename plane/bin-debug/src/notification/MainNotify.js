...
(function (MainNotify) {
    ...
    //打开商店界面
    MainNotify.openShopPanelNotify = "openShopPanelNotify";
    //关闭商店界面
    MainNotify.closeShopPanelNotify = "closeShopPanelNotify";
    //打开选关界面
    MainNotify.openChooseCopyPanelNotify = "openChooseCopyPanelNotify";
    //关闭选关界面
    MainNotify.closeChooseCopyPanelNotify = "closeChooseCopyPanelNotify";
    //打开结束界面
