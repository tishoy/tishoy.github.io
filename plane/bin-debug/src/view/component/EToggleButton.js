...
var EToggleButton = (function (_super) {
    ...
    */
    ...
    var __egretProto__ = EToggleButton.prototype;
    __egretProto__.init = function (backFun, descStr, fontSize, cartoonType, assetsName) {
        if (backFun === void 0) { backFun = null; }
        if (descStr === void 0) { descStr = ""; }
        if (fontSize === void 0) { fontSize = 30; }
        if (cartoonType === void 0) { cartoonType = 1; }
    ...
    //获取是否选择
    __egretProto__.getSelected = function () {
        return this.isSelected;
    };
    //设置按钮是否可用
    __egretProto__.setEnable = function (bool) {
        this.touchEnabled = bool;
    };
    //设置是否选择
    __egretProto__.setSelected = function (bool) {
...
EToggleButton.prototype.__class__ = "EToggleButton";
