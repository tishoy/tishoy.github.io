...
var EButton = (function (_super) {
    ...
    */
    ...
    var __egretProto__ = EButton.prototype;
    __egretProto__.init = function (imgName, backFun, descStr, fontSize, cartoonType, assetsName) {
        if (backFun === void 0) { backFun = null; }
        if (descStr === void 0) { descStr = ""; }
        if (fontSize === void 0) { fontSize = 30; }
        if (cartoonType === void 0) { cartoonType = 1; }
    ...
    __egretProto__.onbuttonTouchTap = function (e) {
    ...
    __egretProto__.initCooldownEffect = function () {
    ...
    __egretProto__.onCDEnd = function (e) {
        this.touchEnabled = true;
    };
    Object.defineProperty(__egretProto__, "cooldownTime", {
        get: function () {
    ...
    __egretProto__.startCooldown = function (time) {
    ...
    //设置绑定数据
    __egretProto__.setBindData = function (data) {
        this.param.data = data;
    };
    //获取绑定数据
    __egretProto__.getBindData = function () {
        return this.param.data;
    };
    __egretProto__.getBitmap = function () {
        return this.btnImg;
    };
    return EButton;
