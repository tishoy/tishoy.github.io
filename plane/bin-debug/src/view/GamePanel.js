...
var GamePanel = (function (_super) {
    ...
    __egretProto__.initPanel = function () {
        ...
        ////this.bodyNum.font = new egret.BitmapFont(RES.getRes("font_json"), );
        //this.bodyNum.x = 360;
        //this.bodyNum.y = 131;
        ...
        ////this.hitNum.font = RES.getRes("font_json");
        //this.hitNum.x = 325;
        //this.hitNum.y = 74;
        ...
        ////this.lastStepNum.font = RES.getRes("font_json");
    ...
    __egretProto__.onAdded = function (e) {
        this.initEffect();
    ...
    __egretProto__.updateHitTimes = function (e) {
    ...
    __egretProto__.onNextCopyConfirm = function () {
        CopyData.getInstance().nextCopy();
        GameController.getInstance().startCopy();
    };
    __egretProto__.onNextCopyCancel = function () {
