...
var PanelManager = (function () {
    ...
    var __egretProto__ = PanelManager.prototype;
    ...
    // 打开选关界面
    PanelManager.openChooseCopyPanel = function () {
    ...
    // 关闭选关界面
    PanelManager.closeChooseCopyPanel = function () {
        if (PanelManager.chooseCopyPanel != null) {
    ...
    PanelManager.openShopPanel = function () {
    ...
    PanelManager.closeShopPanel = function () {
        if (PanelManager.shopPanel != null) {
